package com.example.lib.securitylibaray.general.core.sm3;
...
public class Sm3Kit extends AbstractCoder {
    ...
    @Override
    public String digestSignature(String path)throws IOException {
        ...
        try {
            ...
            bos.flush();
            byte[] sign= digestSignature(data,null);
            return Utils.byteToHex(sign);
        }finally {
            if (fis!=null){
                fis.close();
